...
import com.iokays.config.adapter.persistence.MyRegisteredClientRepositoryAdapter;
import com.iokays.config.adapter.persistence.MyUserInfoMapperAdapter;
import com.iokays.config.device.MyDeviceClientAuthenticationConverter;
import com.iokays.config.device.MyDeviceClientAuthenticationProvider;
...
import static com.iokays.config.adapter.web.AuthorizationConsentController.CUSTOM_CONSENT_PAGE_URI;
