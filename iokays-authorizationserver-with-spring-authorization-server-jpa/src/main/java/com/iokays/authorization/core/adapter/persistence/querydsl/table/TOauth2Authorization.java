...
/**
 * TOauth2Authorization is a Querydsl bean type
 */
@Generated("com.querydsl.codegen.BeanSerializer")
public class TOauth2Authorization {
    ...
    private java.sql.Timestamp authorizationCodeExpiresAt;

    private java.sql.Timestamp authorizationCodeIssuedAt;
    ...
    private java.sql.Timestamp deviceCodeExpiresAt;

    private java.sql.Timestamp deviceCodeIssuedAt;
    ...
    private java.sql.Timestamp oidcIdTokenExpiresAt;

    private java.sql.Timestamp oidcIdTokenIssuedAt;
    ...
    private java.sql.Timestamp refreshTokenExpiresAt;
    ...
    private java.sql.Timestamp userCodeExpiresAt;

    private java.sql.Timestamp userCodeIssuedAt;
    ...
    public void setAccessTokenExpiresAt(java.sql.Timestamp accessTokenExpiresAt) {
    ...
    public void setAccessTokenIssuedAt(java.sql.Timestamp accessTokenIssuedAt) {
    ...
    public void setAuthorizationCodeExpiresAt(java.sql.Timestamp authorizationCodeExpiresAt) {
    ...
    public void setAuthorizationCodeIssuedAt(java.sql.Timestamp authorizationCodeIssuedAt) {
    ...
    public void setDeviceCodeExpiresAt(java.sql.Timestamp deviceCodeExpiresAt) {
    ...
    public void setDeviceCodeIssuedAt(java.sql.Timestamp deviceCodeIssuedAt) {
    ...
    public void setOidcIdTokenExpiresAt(java.sql.Timestamp oidcIdTokenExpiresAt) {
    ...
    public void setOidcIdTokenIssuedAt(java.sql.Timestamp oidcIdTokenIssuedAt) {
    ...
    public void setRefreshTokenExpiresAt(java.sql.Timestamp refreshTokenExpiresAt) {
    ...
    public void setRefreshTokenIssuedAt(java.sql.Timestamp refreshTokenIssuedAt) {
    ...
    public void setUserCodeExpiresAt(java.sql.Timestamp userCodeExpiresAt) {
    ...
    public void setUserCodeIssuedAt(java.sql.Timestamp userCodeIssuedAt) {
