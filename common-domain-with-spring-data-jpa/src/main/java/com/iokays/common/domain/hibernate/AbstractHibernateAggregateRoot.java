 ...
 */
@MappedSuperclass
public abstract class AbstractHibernateAggregateRoot<A extends AbstractHibernateAggregateRoot<A>> extends ConcurrencySafeEntity<A> implements AggregateRoot {
