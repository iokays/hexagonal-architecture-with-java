 ...
 * @since 1.1
 */
public final class MyDeviceClientAuthenticationConverter implements AuthenticationConverter {
    private final RequestMatcher deviceAuthorizationRequestMatcher;
    private final RequestMatcher deviceAccessTokenRequestMatcher;

    public MyDeviceClientAuthenticationConverter(String deviceAuthorizationEndpointUri) {
    ...
    public Authentication convert(HttpServletRequest request) {
        ...
        return new MyDeviceClientAuthenticationToken(clientId, ClientAuthenticationMethod.NONE, null, null);
    }
